        ...
        <div class="col-md-5 ml-auto">
            <div class="info-area info-horizontal mt-5">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Digital platforms') }}</h3>
                    <p class="description">
                        {{ __('Netflix, Amazon Prime, Disney, HBO+, Plex, Star+, Hotgo, Claro Video, Win+, Youtube Premium.') }}
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Catalogs') }}</h3>
                    <p class="description">
                        Carmel, Pacifika, Loguin, E&#39bel, Avon, Natura.
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Coworking') }}</h3>
                    <p class="description">
                        {{ __('Michi Miau, Deliriumbakery.') }}
                    </p>
                </div>
                <br><br>
                <div class="description">
                    <h1 class="info-title">Kata Store</h1>
                    <p class="description">
